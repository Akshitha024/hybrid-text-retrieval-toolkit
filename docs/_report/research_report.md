---
title: "hybrid-text-retrieval-toolkit: Production hybrid retrieval framework with BEIR evaluation"
...
Production hybrid retrieval framework with BEIR evaluation

This report presents the methodology, dataset, evaluation results, and analysis
of the hybrid-text-retrieval-toolkit project. We describe the design choices, baseline
...
Production hybrid retrieval framework with BEIR evaluation The remainder of this section motivates the choice of approach.
